...
namespace TournamentApp.Migrations
{
    public partial class CreateViews : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_PlayoffWinners");
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_HeadToHeadStatistics");
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_ParticipantStatistics");
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_TournamentStandings");
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_MatchDetails");
            migrationBuilder.Sql("DROP VIEW IF EXISTS vw_TournamentWithParticipants");
        }
    }
}
